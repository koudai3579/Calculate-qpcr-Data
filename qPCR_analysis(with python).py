...
resultSheet["L2"] = "結果2（誤差）"
resultSheet["L3"] = sampleNames[0]
resultSheet["L4"] = sampleNames[1]
resultSheet["L5"] = sampleNames[2]
resultSheet["L6"] = sampleNames[3]
resultSheet["L7"] = sampleNames[4]
